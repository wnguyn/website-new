...
function trackHtml(track) {
	...
	const coverElement = cover
		? `<span class="lastfm-cover-link"><img class="lastfm-cover" src="${escapeHtml(cover)}" alt="" loading="lazy" /></span>`
		: '<span class="lastfm-cover"></span>';
	const titleElement = url
		? `<a class="lastfm-title" href="${escapeHtml(url)}" target="_blank" rel="noopener noreferrer">${escapeHtml(title)}</a>`
